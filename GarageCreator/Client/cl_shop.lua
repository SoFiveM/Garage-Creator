...
MenuCreator = {
	Base = {Header = {"commonmenu", "interaction_bgd"}},
	...
	Menu = {  
        ["Action"] = {
            b = {
                ...
                {name = "Type de garage", slidemax = {"2 places", "4 places", "6 places", "10 places", "11 places (helicoptaire)", "12 places (luxe)", "24 places", "94 places"}}, 
