...
function PMenu:drawMenuButton(button, intX, intY, boolSelected, intW, intH, intID)
	...
	local result = (self.Events["setLock"] and self.Events["setLock"](button, self.Data.currentMenu, self)) or (button.image and button.image) 
